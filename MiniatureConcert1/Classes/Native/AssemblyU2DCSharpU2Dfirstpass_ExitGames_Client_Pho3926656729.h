...
struct  LoadBalancingPeer_t3926656729  : public PhotonPeer_t2940878176
{
public:
...
public:
	inline static int32_t get_offset_of_opParameters_36() { return static_cast<int32_t>(offsetof(LoadBalancingPeer_t3926656729, ___opParameters_36)); }
