...
struct  SamplingRate_t1724360513 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SamplingRate_t1724360513, ___value___1)); }
