...
struct  OpusCtlGetRequest_t1315908173 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(OpusCtlGetRequest_t1315908173, ___value___1)); }
