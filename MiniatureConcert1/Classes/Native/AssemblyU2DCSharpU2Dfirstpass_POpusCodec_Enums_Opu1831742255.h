...
struct  OpusApplicationType_t1831742255 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(OpusApplicationType_t1831742255, ___value___1)); }
