...
struct  EncryptionMode_t2216351142 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EncryptionMode_t2216351142, ___value___1)); }
